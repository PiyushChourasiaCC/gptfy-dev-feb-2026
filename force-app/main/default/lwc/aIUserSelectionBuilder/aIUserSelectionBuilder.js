...
import getUsers from '@salesforce/apex/AIWorkspaceProcessingPolicyController.getUsers';

export default class AIUserSelectionBuilder extends LightningElement {
    ...
    async doInit(){
        getUsers()
        .then(result => {
            this.userOptions = JSON.parse(JSON.stringify(result));
            if(this.fieldValue){
